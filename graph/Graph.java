...
//        return null;
    ...
    public void addUndirectedEdgeBetweenNodes(int node1Index, int node2Index, String line) {
        addEdgeBetweenNodes(node1Index, node2Index, line);
        addEdgeBetweenNodes(node2Index, node1Index, line);
    }

    public void addEdgeBetweenNodes(int node1Index, int node2Index, String line) {
        Node node1 = nodes.get(node1Index);
        Node node2 = nodes.get(node2Index);

        Edge edge = new Edge(node1, node2, line);
