...
public class GraphProperties {
    ...
    public void girvanNewman() {
        ...
        while (connectedComponents().size() < targetCC) {
            ...
            System.out.println("Removing : " + String.join(", ", edgesToRemove.stream().map(e -> e.getNodeFrom().getLabel() + " / " + e.getNodeTo().getLabel()).collect(Collectors.toList())));
            ...
            if (connectedComponents().size() != currentCC) {
                ...
                for (List<Node> nodes : connectedComponents()) {
                    System.out.println("* " + String.join(", ", nodes.stream().map(n -> n.getLabel()).collect(Collectors.toList())));
